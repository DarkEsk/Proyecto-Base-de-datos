Public Class AgregarAlumnoscomandos
    ...
    Public Sub eliminaalumnos()
        ...
        renglon = AgregarAlumnos.DataGridAlumnos.CurrentCellAddress.Y

        'Con el IF validamos que no falten datos y que sean del tipo de dato requerido
        Try
            strSql = "delete from alumnos where no_control = " & AgregarAlumnos.DataGridalumnos.Rows(renglon).Cells(0).Value
            xCnx.objetoCommand(strSql)
    ...
    Public Sub ponerencuadros()
        ...
        columna = AgregarAlumnos.DataGridAlumnos.CurrentCellAddress.Y
        AgregarAlumnos.TextBoxNoControl.Text = AgregarAlumnos.DataGridAlumnos.Rows(columna).Cells(0).Value
        AgregarAlumnos.TextBoxIdGenero.Text = AgregarAlumnos.DataGridAlumnos.Rows(columna).Cells(1).Value
        AgregarAlumnos.TextBoxIdCarrera.Text = AgregarAlumnos.DataGridAlumnos.Rows(columna).Cells(2).Value
        AgregarAlumnos.TextBoxIdEquipo.Text = AgregarAlumnos.DataGridAlumnos.Rows(columna).Cells(3).Value
        AgregarAlumnos.TextBoxNombre.Text = AgregarAlumnos.DataGridAlumnos.Rows(columna).Cells(4).Value
        AgregarAlumnos.TextBoxPaterno.Text = AgregarAlumnos.DataGridAlumnos.Rows(columna).Cells(5).Value
        AgregarAlumnos.TextBoxMaterno.Text = AgregarAlumnos.DataGridAlumnos.Rows(columna).Cells(6).Value
    End Sub
End Class
